...
void heapify(int * arr, int n, int i, int * key){  //organiza a arvore
...
void HeapDecrease(int * heap, int a, int dec, int size, int * key){ //Decrementando 
...
int GetV(char * str){   //pegar os valores
...
void FillTable(char * str, int * table){ //preenche a tabela
...
int main(){
    ...
    int size = GetV("dij40.txt"); //o arquivo que preferir
